<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"G:\www.shop.com\public/../application/home\view\public\login.html";i:1533522237;}*/ ?>
				...
				<form action="" method="post">
					<ul>
						...
						<li class="checkcode">
							...
							<img src="<?php echo captcha_src('2'); ?>" id='captcha' alt="" />
...
<script type="text/javascript">
	...
	$("#changeCaptcha").on('click',function(){
		$("#captcha").attr('src',"<?php echo captcha_src('2'); ?>?_="+Math.random());
	});
	$("#changeCaptcha").click();
</script>
</html>