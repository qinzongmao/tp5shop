<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"G:\www.shop.com\public/../application/home\view\public\setnewpassword.html";i:1533375042;}*/ ?>
		...
		<div class="login_bd">
			...
			<div class="login_form fl">
					<ul>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="submit" value="提交" class="login_btns" />
						</li>
					</ul>				
			</div>
			</form>
