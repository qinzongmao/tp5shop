<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"G:\www.shop.com\public/../application/home\view\order\selforder.html";i:1533805838;s:56:"G:\www.shop.com\application\home\view\public\header.html";i:1533804571;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/home.css" type="text/css">
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/order.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo config('home_static'); ?>/js/home.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
				...
				<table class="orders">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $v['receiver'].'/'.$v['phone']; ?></td>
							...
							<td>
								...
								<?php  if( $v['pay_status'] == 0 ):?>
									<a href="<?php echo url('/home/order/payMoney',['order_id'=>$v['order_id']]); ?>">付款</a>
								<?php endif; ?>
							</td>
						</tr>
						<?php endforeach; ?>
