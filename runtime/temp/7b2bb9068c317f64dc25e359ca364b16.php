<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"G:\www.shop.com\public/../application/admin\view\index\left.html";i:1533027069;}*/ ?>
    ...
    <dl class="leftmenu">
        ...
        <dd>
            ...
            <ul class="menuson">
                ...
                <li>
                    <cite></cite><a href="<?php echo url('/admin/'.$auths[$two]['auth_c'].'/'.$auths[$two]['auth_a']); ?>" target="rightFrame"><?php echo $auths[$two]['auth_name']; ?></a><i></i>
                </li>
             <?php endforeach;?>
            </ul>
        </dd>
