<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"G:\www.shop.com\public/../application/home\view\category\index.html";i:1533625422;s:56:"G:\www.shop.com\application\home\view\public\header.html";i:1533804571;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/list.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo config('home_static'); ?>/js/list.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：
				<a href="/">首页</a> 
			<?php foreach($familysCat as $cat): ?>
				> <a href="<?php  echo url('/home/category/index',['cat_id'=>$cat['cat_id']]) ?>"><?php echo $cat['cat_name']; ?></a>
 			<?php endforeach; ?>
			</h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="list_left fl mt10">
				...
				<div class="catlist_wrap">
					...
					<div class="child">
						...
						<ul>
							...
							<li><a href="<?php echo url('/home/category/index',['cat_id'=>$three_cat_id]); ?>"><?php echo $catsData[ $three_cat_id ]['cat_name']; ?></a></li>
							<?php endforeach; ?>
						</ul>
					</div>
					<?php endforeach; ?>
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/list_hot3.jpg" alt="" /></a></dt>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					...
					<dl class="last">
						<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/crazy4.jpg" alt="" /></a></dt>
