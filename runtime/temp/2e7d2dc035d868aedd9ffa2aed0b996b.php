<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"G:\www.shop.com\public/../application/home\view\goods\detail.html";i:1533776728;s:56:"G:\www.shop.com\application\home\view\public\header.html";i:1533804571;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/goods.css" type="text/css">
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/common.css" type="text/css">
	...
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/jqzoom.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo config('home_static'); ?>/js/goods.js"></script>
	<script type="text/javascript" src="<?php echo config('home_static'); ?>/js/jqzoom-core.js"></script>
...
<body>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="/">首页</a> 
			    <?php foreach($familyCats as $v): ?>
			     > <a href="<?php echo url('/home/category/index',['cat_id'=>$v['cat_id']]); ?>"><?php echo $v['cat_name']; ?></a> 
			    <?php endforeach; ?>
			
				> <?php echo $goodsInfo['goods_name']; ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/relate_view5.jpg" alt="" /></a></dt>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
				    <?php foreach($historyDatas as $v): ?>
				     <dl>
						<dt><a href=""><img src="/static/upload/<?php echo json_decode($v['goods_thumb'])[0]; ?>" alt="" /></a></dt>
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/static/upload/<?php echo $goodsInfo['goods_img'][0]; ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/static/upload/<?php echo $goodsInfo['goods_middle'][0]; ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<!-- 图片的顺序：中->大->小 -->
								 <?php foreach($goodsInfo['goods_middle'] as $k=>$m): ?>
								<li <?php echo $k==0?'class="cur"':''; ?>>
									<a <?php echo $k==0?'class="zoomThumbActive"':''; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/static/upload/<?php echo $m; ?>',largeimage: '/static/upload/<?php echo $goodsInfo['goods_img'][$k]; ?>'}">
										<img src="/static/upload/<?php echo $goodsInfo['goods_thumb'][$k]; ?>"></a>
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo $goodsInfo['create_time']; ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>
							<!-- 遍历单选属性 -->
							<?php foreach($singelAttrDatas  as $v): ?>
							<li class="product">
								<dl>
									<dt><?php echo $v[0]['attr_name']; ?>：</dt>
									<dd>
										<!-- 循环单选属性的多个值 -->
										<?php foreach($v as $k=>$attr): ?>
										<a <?php echo $k==0?'class="selected"':''; ?> href="javascript:;">
											<?php echo $attr['attr_value'].'价格-&yen;'.$attr['attr_price']; ?> <input type="radio" name="color" value="<?php echo $attr['goods_attr_id']; ?>" <?php echo $k==0?'checked="checked"':''; ?> />
										</a>
										<?php endforeach; ?>
							...
							<li>
								<dl>
									...
									<dd>
										<!-- 加入购物车 -->
										<input type="button"  goods_id="<?php echo $goodsInfo['goods_id']; ?>" id="addCart" class="add_btn" />
									</dd>
								</dl>
							</li>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div ">
						<div class="attr mt15">
							<ul>
								<!-- 遍历商品的唯一属性 -->
								<?php foreach($onlyAttrDatas as $v): ?>
					...
					<!-- <div class="comment detail_div mt10">
                        ...
                        <div class="comment_items mt10">
                            <div class="user_pic">
                                <dl>
                                    <dt><a href=""><img src="<?php echo config('home_static'); ?>/images/user1.gif" alt="" /></a></dt>
                                    <dd><a href="">乖乖</a></dd>
                                </dl>
                            </div>
                            <div class="item">
                        ...
                        <div class="comment_items mt10">
                            <div class="user_pic">
                                <dl>
                                    <dt><a href=""><img src="<?php echo config('home_static'); ?>/images/user2.jpg" alt="" /></a></dt>
                                    <dd><a href="">小宝贝</a></dd>
                                </dl>
                            </div>
                            <div class="item">
                        ...
                        <div class="comment_items mt10">
                            <div class="user_pic">
                                <dl>
                                    <dt><a href=""><img src="<?php echo config('home_static'); ?>/images/user3.jpg" alt="" /></a></dt>
                                    <dd><a href="">天使</a></dd>
                                </dl>
                            </div>
                            <div class="item">
...
<script type="text/javascript">
	...
	$("#addCart").on('click',function(){
		//获取三个参数:数量，商品goods_id,属性id
		var goods_number = $("input[name='amount']").val();
		var goods_id = $(this).attr('goods_id');
		//获取class=selected下面的input元素，即获取到选中的属性
		var  attr = $(".selected > input");
		//循环获取属性值
		var goods_attr_ids = [];
		for(var i=0;i<attr.length;i++){
			//console.log(attr[i].value); //DOM方式
			//console.log($(attr[i]).val()); //jquery方式
			//把值加入到数组goods_attr_ids中
			goods_attr_ids.push(attr[i].value);
		}
		//把属性数组形式，转为用逗号链接的字符串
		goods_attr_ids = goods_attr_ids.join(','); //
		//发送ajax到购物车
		var param = {"goods_id":goods_id,"goods_number":goods_number,"goods_attr_ids":goods_attr_ids};
		$.get("<?php echo url('/home/cart/addGoodsToCart'); ?>",param,function(res){
			console.log(res);
			if(res.code == -1){
				//询问框
				layer.confirm(res.message, {
				  btn: ['好的','不想登录'] //按钮
				  	...
				  	//确定的逻辑，点击了好的，跳转到登录页面 (携带一个访问当前商品的id)
				  	location.href = "<?php echo url('/home/public/login',[ 'goods_id'=>$goodsInfo['goods_id'] ]); ?>";
				}, function(){
				   //取消的逻辑
				});
				//alert(res.message);
