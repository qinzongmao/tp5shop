<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"G:\www.shop.com\public/../application/home\view\index\index.html";i:1533626751;s:56:"G:\www.shop.com\application\home\view\public\header.html";i:1533804571;}*/ ?>
...
<head>
	...
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/index.css" type="text/css">
	<link rel="stylesheet" href="<?php echo config('home_static'); ?>/style/bottomnav.css" type="text/css">
	...
	<script type="text/javascript" src="<?php echo config('home_static'); ?>/js/header.js"></script>
	<script type="text/javascript" src="<?php echo config('home_static'); ?>/js/index.js"></script>
</head>
<body>
	<!-- 顶部导航 start -->
	<div class="topnav">
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="<?php echo config('home_static'); ?>/images/logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
				...
				<dl>
					...
					<dd>
						...
						<div class="viewlist mt10">
							<h3>最近浏览的商品：</h3>
							<ul>
								<li><a href=""><img src="<?php echo config('home_static'); ?>/images/view_list1.jpg" alt="" /></a></li>
								<li><a href=""><img src="<?php echo config('home_static'); ?>/images/view_list2.jpg" alt="" /></a></li>
								<li><a href=""><img src="<?php echo config('home_static'); ?>/images/view_list3.jpg" alt="" /></a></li>
							</ul>
						</div>
					</dd>
				</dl>
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="<?php echo config('home_static'); ?>/images/holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="<?php echo config('home_static'); ?>/images/scenic.jpg" alt="" /></a>
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="<?php echo config('home_static'); ?>/images/sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo config('home_static'); ?>/images/taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo config('home_static'); ?>/images/wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<?php foreach($crazyDatas as $goods): ?>
						<li>
							<dl>
								<dt><a href="<?php echo url('/home/goods/detail',['goods_id'=>goods['goods_id']]); ?>"><img src="/static/upload/<?php echo json_decode($goods['goods_middle'])[0]; ?>" alt="" /></a></dt>
								<dd><a href="<?php echo url('/home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><?php echo $goods['goods_name']; ?></a></dd>
								<dd><span>售价：</span><strong> ￥ <?php echo $goods['goods_price']; ?></strong></dd>
							</dl>
						</li>
						<?php endforeach; ?>
				...
				<div class="recommend none">
					<ul>
						<?php foreach($bestDatas as $goods): ?>
						<li>
							<dl>
								<dt><a href="<?php echo url('/home/goods/detail',['goods_id'=>goods['goods_id']]); ?>"><img src="/static/upload/<?php echo json_decode($goods['goods_middle'])[0]; ?>" alt="" /></a></dt>
								<dd><a href="<?php echo url('/home/goods/detail',['goods_id'=>$goods['goods_id']]); ?>"><?php echo $goods['goods_name']; ?></a></dd>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="<?php echo config('home_static'); ?>/images/viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="<?php echo config('home_static'); ?>/images/samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/hpG4.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/acer4739.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo config('home_static'); ?>/images/qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/dell.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/acer.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo config('home_static'); ?>/images/intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
