<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"G:\www.shop.com\public/../application/admin\view\category\index.html";i:1533110978;}*/ ?>
        ...
        <table class="tablelist">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo str_repeat('&nbsp;',$cat['level']*3); ?><?php echo $cat['cat_name']; ?></td>
                    <td><?php echo $cats[ $cat['pid'] ]['cat_name']; ?></td>
                    <td><?php echo config('is_show')[ $cat['is_show'] ]; ?></td>
                    <td>
                        <a href="<?php echo url('/admin/category/upd',['cat_id'=>$cat['cat_id']]); ?>" class="tablelink">编辑</a> 
                        <a href="<?php echo url('/admin/category/del',['cat_id'=>$cat['cat_id']]); ?>" onclick="return confirm('确认删除？')" class="tablelink"> 删除</a>
                    </td>
                </tr>
